...
function SKIN:PaintScorePanel( panel )
	...
	draw.RoundedBox( 8, 0, 8, panel:GetWide(), panel:GetTall()-8, Color( 50, 50, 50, 200 ) )
...
function SKIN:PaintScoreHeader( panel )
	...
	draw.RoundedBox( 8, 0, 0, panel:GetWide(), panel:GetTall()*2, col)
...
derma.DefineSkin( "LaserTag", "", SKIN )