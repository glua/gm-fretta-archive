...
function GM:PaintAmmo()
	...
	local JetIndicator = vgui.Create( "DHudUpdater" )
		JetIndicator:SizeToContents()
		JetIndicator:SetValueFunction( function() return LocalPlayer():GetNWInt( "Fuel", 0 ) end )
		JetIndicator:SetLabel( "FUEL" )
		JetIndicator:SetFont( "FHUDElement" )
		
	Bar:AddItem( JetIndicator )
