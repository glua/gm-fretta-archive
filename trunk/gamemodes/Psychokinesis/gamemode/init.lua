...
AddCSLuaFile( 'player_class/class_phycho.lua' )
...
function GM:DoPlayerDeath( ply, attacker, dmginfo )
	...
	ply:CreateRagdoll()
	ply:AddDeaths( 1 )
	if(!(attacker:GetNWEntity(1) == nil) and attacker:GetNWEntity(1))then
		attacker = attacker:GetNWEntity(1)
	end
	umsg.Start("PlayerKilled2")
		umsg.Entity( ply)
		umsg.String( "Prop" )
