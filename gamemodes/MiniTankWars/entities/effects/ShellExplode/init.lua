...
------------------------
ShellExplode init.lua
	-Shell Explode(Hit) Effect init
*/
...
function EFFECT:Init( data )
	...
	local emitter = ParticleEmitter( vOffset )
		...
		//smoke
		for i=0, 32 do
			local vPos = Vector( math.Rand(-25,25)+vOffset.x, math.Rand(-25,25)+vOffset.y, math.Rand(-25,25)+vOffset.z )
		...
		for i=0, 16 do
			...
			if (particle) then
				...
				particle:SetVelocity( (vPos - vOffset) * 15 )
				particle:SetLifeTime( 0 )
