...
function EFFECT:Init( data )
	...
	SurfaceColor.r = math.Clamp( SurfaceColor.r + 155, 155, 255 )
	SurfaceColor.g = math.Clamp( SurfaceColor.g + 155, 155, 255 )
	SurfaceColor.b = math.Clamp( SurfaceColor.b + 155, 155, 255 )
